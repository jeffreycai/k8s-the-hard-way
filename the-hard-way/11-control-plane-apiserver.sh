...
## Setting up k8s api server
header "Setting up the Kubernetes API Server ..."

for instance in $CTRL0_IP_PUBLIC $CTRL1_IP_PUBLIC; do
  log "Setting up k8s api server for instance $instance .."

  script=${ARTIFACTS_DIR}/${instance}-ctl-apiserver.sh
